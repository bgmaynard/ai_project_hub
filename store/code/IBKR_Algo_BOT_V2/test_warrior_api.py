...
class WarriorAPITester:
    ...
    async def test_system_status(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"Risk Manager initialized: {data.get('risk_manager_initialized')}")
                ...
                self.log_result("System Status", False, f"Status {response.status_code}")
                return False
        except Exception as e:
    ...
    async def test_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                print(f"Daily profit goal: ${data.get('risk_management', {}).get('daily_profit_goal')}")
                print(f"Max loss per trade: ${data.get('risk_management', {}).get('max_loss_per_trade')}")
                print(f"Min R:R ratio: {data.get('risk_management', {}).get('min_reward_to_risk')}:1")
                print(f"Enabled patterns: {len(data.get('pattern_detection', {}).get('enabled_patterns', []))}")
                self.log_result("Configuration", True)
                return True
            else:
                self.log_result("Configuration", False, f"Status {response.status_code}")
                return False
        except Exception as e:
    ...
    async def test_premarket_scan(self):
        ...
        try:
            ...
            response = await self.client.post(
                f"{self.base_url}{API_PREFIX}/scan/premarket",
                json={}
            )
            ...
            if response.status_code == 200:
                ...
                self.log_result("Pre-Market Scan", False, f"Status {response.status_code}")
                return []
        except Exception as e:
            ...
            if response.status_code == 200:
                ...
                if watchlist:
                    ...
                    for i, candidate in enumerate(watchlist[:3], 1):
                        print(f"  {i}. {candidate.get('symbol')} - "
                ...
                self.log_result("Watchlist Retrieval", False, f"Status {response.status_code}")
                return []
        except Exception as e:
    ...
    async def test_risk_status(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_result("Risk Manager Status", False, f"Status {response.status_code}")
                return False
        except Exception as e:
    ...
    async def test_trade_history(self):
        ...
        try:
            response = await self.client.get(f"{self.base_url}{API_PREFIX}/trades/history")
            ...
            if response.status_code == 200:
                ...
                self.log_result("Trade History", False, f"Status {response.status_code}")
                return False
        except Exception as e:
    ...
    async def test_mock_trade_lifecycle(self):
        ...
        try:
            ...
            entry_response = await self.client.post(
                f"{self.base_url}{API_PREFIX}/trades/enter",
                json=entry_request
            )
            ...
            if entry_response.status_code == 200:
                ...
                exit_response = await self.client.post(
                    f"{self.base_url}{API_PREFIX}/trades/exit",
                    json=exit_request
                )
    ...
    async def test_reset_daily_stats(self):
        ...
        try:
            response = await self.client.post(f"{self.base_url}{API_PREFIX}/risk/reset-daily")
            ...
            if response.status_code == 200:
                ...
                self.log_result("Reset Daily Stats", False, f"Status {response.status_code}")
                return False
        except Exception as e:

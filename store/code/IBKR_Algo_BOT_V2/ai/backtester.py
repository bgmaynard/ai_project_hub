...
class Backtester:
    ...
    def backtest(self, symbol: str, predictor, start_date: str, end_date: str, 
                 confidence_threshold=0.65, prob_threshold=0.60, position_size=5):
        ...
        train_start = (pd.to_datetime(start_date) - timedelta(days=730)).strftime('%Y-%m-%d')
        ...
        for i in range(len(df) - 1):
            ...
            try:
                ...
                if (prediction['confidence'] >= confidence_threshold and 
                    prediction['prob_up'] >= prob_threshold and
                ...
                if symbol in self.positions:
                    ...
                    pnl_pct = ((next_price - position['entry_price']) / position['entry_price']) * 100
        ...
        results['total_return'] = ((results['final_capital'] - self.initial_capital) / self.initial_capital) * 100
        ...
        print(f"Backtest complete: {results['total_trades']} trades, {results['total_return']:.2f}% return")
        return results
